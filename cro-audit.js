...
function context(term){const i=html.indexOf(term); console.log(`\n=== CONTEXT ${term} @ ${i} ===`); if(i>=0) console.log(html.slice(Math.max(0,i-900),Math.min(html.length,i+900)));}
context('4,9');
context('Persönlicher Cashflow-Plan');
context('Marktverständnis');
context('Risikomanagement');
context('Dein Cashflow-Profil wird erstellt.');
console.log('\n=== BODY TEXT SAMPLE ===');
